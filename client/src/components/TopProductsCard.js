      ...
      <div className="space-y-4">
        {products.map((product, index) => (
          ...
          >
            ...
            <div className="flex-shrink-0">
              <div
                className={`w-10 h-10 rounded-lg flex items-center justify-center text-xl transition-colors duration-300 ${
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="flex items-center mt-1">
                    <span
                      className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium transition-all duration-300 ${getCategoryColor(
                        product.category
                      )}`}
                    >
                      {product.category}
                ...
                <div className="text-right">
                  ...
                  >
                    {product.sales} {product.unit} sold
                  </p>
                  <p
